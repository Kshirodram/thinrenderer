  ...
  _createClass(MobileListView, [
    {
      ...
      value: function render() {
        ...
        return _react2['default'].createElement('div', null, _react2['default'].createElement('li', {
          className: 'list-header'
        }, _react2['default'].createElement('span', null, navData.title)), navData.links && navData.links.length
          ? navData.links.map(function(obj) {
            if (obj.text == 'Clubcard') {
              return _react2['default'].createElement('li', {
                ...
                className: ' list-item-icon list-item-icon-left ' + obj.icon
              }), _react2['default'].createElement('span', {className: 'list-item-icon list-item-icon-right icon-link'}), _react2['default'].createElement('span', {
  ...
  function HeaderComponent(props) {
    ...
    this.state = {
      ...
      headerData: this.props.data
        ? this.props.data[0].module.resources
        : [],
      navigationData: this.props.data
        ? this.props.data[1].module.resources
        : [],
      meta: {
  ...
  _createClass(HeaderComponent, [
    {
      ...
      value: function componentWillMount() {
        ...
        if (!this.props.data) {
          _getData(this.props.contentModel).then(function(data) {
            scope.setState({headerData: data[0].module.resources, navigationData: data[1].module.resources});
          }, function(err) {
            console.log(err);
          });
        }
      ...
      value: function _switchLang() {
        if (typeof window == undefined) {
          var op = "";
          for (var query in window.location.search.split('&')) {
            if (window.location.search.split('&')[query].indexOf('lang') >= 0) {
              op = window.location.search.split('&')[query].split('=')[1];
            }
          }
      ...
      value: function render() {
        ...
        return headerData && navData
          ? _react2['default'].createElement('div', {
            ...
            href: '#',
            className: 'menu-tab menu-link',
            onClick: this._openNavigation.bind(this)
          }), _react2['default'].createElement('div', {
            ...
            name: 'header-search',
            placeholder: this.state.headerData.searchBarTitle,
            type: 'search'
          }), _react2['default'].createElement('a', {
            href: '#',
            className: 'button secondary'
          }, _react2['default'].createElement('i', {className: 'search-icon'}))), _react2['default'].createElement('div', {
            className: 'column medium-3 large-3 support-group'
          }, _react2['default'].createElement('div', {
            className: 'cell',
            onClick: this._switchLang.bind(this)
          }, _react2['default'].createElement('span', {
            className: 'link-text'
            ...
            if (!item[self.state.meta.lang]) {
              return _react2['default'].createElement('span', null, _react2['default'].createElement('span', {
                className: item[Object.keys(item)[1]] + " lang-icon"
              }), _react2['default'].createElement('a', {
                href: "?loggedOn=false&lang=" + Object.keys(item)[0] + "&country=PL"
              }, item[Object.keys(item)[0]]));
            }
          }))), headerData && headerData.links
            ? headerData.links[0].infoLinks.map(function(obj) {
            ...
            ? headerData.links[0].signinPanelLinks.map(function(val, index) {
              var classNames = '';
              if (index == 0) {
            ...
            : "")), _react2['default'].createElement('div', {className: 'divider'}), _react2['default'].createElement('div', {
            className: 'row menu-list'
          }, _react2['default'].createElement('div', {
            className: 'column medium-10 menu-items'
          }, navData.length
            ? navData[0].links.map(function(obj, index) {
              return _react2['default'].createElement('div', {
                className: 'menu-item'
                ...
                ? _react2['default'].createElement('span', {className: 'icon-down-triangle groceries-down-icon'})
                : ""));
            })
            : ""))), _react2['default'].createElement('a', {
            href: '#',
            ...
            className: this.state.isNavBarOpen
            ...
            ? _react2['default'].createElement('a', {
              className: 'header-button button-primary main-nav-header-button',
              href: headerData.links[0].signinPanelLinks[0].url
            }, headerData.links[0].signinPanelLinks[0].text)
            : "", _react2['default'].createElement('div', {className: 'vertical-divider'}), headerData && headerData.links
          ? _react2['default'].createElement('a', {
            className: 'header-button button-primary main-nav-header-button',
            href: headerData.links[0].signinPanelLinks[1].url
          ...
          if (!item[self.state.meta.lang]) {
            return _react2['default'].createElement('a', {
              ...
              className: "list-item-icon list-item-icon-left " + item[Object.keys(item)[1]]
            }), _react2['default'].createElement('span', {
              className: 'list-item-single-line'
            }, item[Object.keys(item)[0]]));
          }
